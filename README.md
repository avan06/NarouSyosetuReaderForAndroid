...
* 🗣️ **TTS（テキスト読み上げ）：**
  ...
  * バックグラウンド再生に対応し、画面をオフにした状態でも再生が可能。
  * 読み上げ速度調整、音声エンジン・言語選択可能。
  * 章を切り替えた際の再生位置の自動リセットや、設定から「次の話を自動で読み上げる」オプションを有効にすることで連続再生にも対応。
  * 自動スクロール＆ハイライト表示付きで読み上げに対応。
  * 音声カスタム辞書： 漢字の読み間違いがある場合、好みの読み方に修正できる辞書登録機能に対応。
...
* 🗣️ **TTS (Text-to-Speech) Narration:**
  ...
  * Implemented background playback, allowing you to listen even with the screen turned off.
  ...
  * **Custom TTS Dictionary:** Correct mispronunciations by adding custom rules for specific words or Kanji.
